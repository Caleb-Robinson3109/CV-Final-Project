...
# Permutation indices for the full set of 59 joints
EXTRA_FLIP_PERM = [0,1,2,4,3,6,5,7,9,8] #'Spine', 'Spine2', 'Spine3', 'left_foot', 'right_foot', 'left_collar', 'right_collar', 'head', 'left_hand', 'right_hand'
J59_FLIP_PERM = J49_FLIP_PERM + [49+i for i in EXTRA_FLIP_PERM]
